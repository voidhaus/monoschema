...
export default function GettingStartedPage() {
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-[#0a0a0f] to-[#181825] flex flex-col text-white overflow-hidden">
      ...
      <svg
        className="pointer-events-none absolute z-0 top-[-60px] right-[-60px] w-[180px] h-[180px] opacity-20 blur animate-spin-slow"
      ...
      <svg
        className="pointer-events-none absolute z-0 left-[-60px] top-1/2 -translate-y-1/2 w-[120px] h-[120px] opacity-20 animate-pulse"
      ...
      <svg
        className="pointer-events-none absolute z-0 bottom-10 left-[-40px] w-[100px] h-[80px] opacity-10"
        viewBox="0 0 100 80"
        fill="none"
      >
        <polygon
      ...
      <svg
        className="pointer-events-none absolute z-0 top-1/3 right-0 w-[180px] h-[40px] opacity-10"
        viewBox="0 0 180 40"
        fill="none"
      >
        <line
...
npm install @voidhaus/monoschema`}
          ...
          <Card disablehover className="mb-8 shadow-xl">
            ...
            <CodeWindow language="typescript">
  ...
  console.error(result.error);
          ...
          <Card disablehover className="mb-8 shadow-xl">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <Card
                disablehover
                className="bg-[#23234b] border border-[#35357a]"
              >
