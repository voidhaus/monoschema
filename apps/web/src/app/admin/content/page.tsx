            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <div className="space-y-2 text-sm">
                  <p><span className="font-medium">Current Branch:</span> {status.status.currentBranch}</p>
                  ...
                  <p>
                    ...
                    <span className={`ml-2 px-2 py-1 rounded text-xs ${
                      ...
                      {status.status.isClean ? 'Clean' : 'Has Changes'}
                    </span>
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <div className="space-y-1">
                  {status.status.changedFiles.length > 0 ? (
                    status.status.changedFiles.map((file) => (
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                <Link
                  key={file.path}
                  href={`/admin/editor?file=${encodeURIComponent(file.path)}`}
